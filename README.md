...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/lucky-fog-7546
```

A live public deployment of this template is available at [https://lucky-fog-7546.templates.workers.dev](https://lucky-fog-7546.templates.workers.dev)
